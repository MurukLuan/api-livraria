package com.luan.livraria.domain;
...
public class Livro implements Serializable{
	...
	@Length(min = 3 , max = 75, message = "O campo Titulo deve ter entre 3 a 75 caracteres.")
	...
	@Length(min = 10 , max = 1000, message = "O campo TEXTO  deve ter entre 10 a 1000(mil) caracteres.")
