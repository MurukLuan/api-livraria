...
import com.luan.livraria.dtos.CategoriaDTO;
...
public class CategoriaService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new com.luan.livraria.exceptions.DataIntegrityViolationException("Categoria não pode ser deletada, possui livros associados");
